		...
		<table border=0 align="center">
			<tr>
				...
				<td><select class="form-control" id="conditions" name="conditions">
					<option value="Select" selected>Select Book</option>
					<option value="HTML Complete Reference" selected>HTML Complete Reference (TK.1000)</option>
					<option value="Html edition 2">Html edition 2 (TK. 1500)</option>
					<option value="CSS Complete Reference" selected>CSS Complete Reference (TK.1000)</option>
					<option value="CSS edition 2">CSS edition 2 (TK. 1500)</option>
				</select></td>
			</tr>
			<tr>
